...
#add paremeters
flags = tf.app.flags
flags.DEFINE_integer("epoch", 1, "Epoch to train [1]")
flags.DEFINE_string("train_patch_dir", "D:/patches", "Directory of the training data [patches]")
flags.DEFINE_bool("split_train", True, "Whether to split the train data into train and val [True]")
flags.DEFINE_string("train_data_dir", "./Brats18TrainingData", "Directory of the train data [./Brats18TrainingData]")
flags.DEFINE_string("deploy_data_dir", "./Brats18ValidationData", "Directory of the test data [./Brats17ValidationData]")
flags.DEFINE_string("deploy_output_dir", "./output_validation", "Directory name of the output data [output]")
flags.DEFINE_string("train_csv", "./Brats18TrainingData/survival_data.csv", "CSV path of the training data")
flags.DEFINE_string("deploy_csv", "./Brats18ValidationData/survival_evaluation.csv", "CSV path of the validation data")
...
flags.DEFINE_boolean("run_survival", True, "True if run survival prediction [True]")
FLAGS = flags.FLAGS
...
def main(_):
    ...
    # Segmentation net
    if FLAGS.run_seg:      
        run_config = tf.ConfigProto() #choose CPU or GPU
        ...
        with tf.Session(config=run_config) as sess:
            ...
            if FLAGS.train:
                ...
                unet.deploy(FLAGS.deploy_data_dir, FLAGS.deploy_output_dir, FLAGS.checkpoint_dir)
    ...
    if FLAGS.run_survival:
        ...
        with tf.Session(config=run_config) as sess:
            ...
            if FLAGS.train:
                ...
                survivalvae.deploy(FLAGS.deploy_survival_paths, FLAGS.deploy_survival_data)
